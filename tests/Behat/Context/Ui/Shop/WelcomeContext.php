...
namespace Tests\LRuozzi9\SyliusElasticsearchPlugin\Behat\Context\Ui\Shop;

use Behat\Behat\Context\Context;
use Tests\LRuozzi9\SyliusElasticsearchPlugin\Behat\Page\Shop\WelcomePageInterface;
