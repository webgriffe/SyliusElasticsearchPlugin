 ...
 * @psalm-type ESDefaultOptionAggregation = array{meta: array{type: string}, doc_count: int, filtered_options: array{doc_count: int, option: array{doc_count_error_upper_bound: int, sum_other_doc_count: int, buckets: array<array-key, array{key: string, doc_count: int, values: array{doc_count: int, value: array{doc_count_error_upper_bound: int, sum_other_doc_count: int, buckets: array<array-key, array{key: string, doc_count: int, label: array{doc_count_error_upper_bound: int, sum_other_doc_count: int, buckets: array<array-key, array{key: string, doc_count: int}>}}>}}, label: array{doc_count_error_upper_bound: int, sum_other_doc_count: int, buckets: array<array-key, array{key: string, doc_count: int}>}}>}}}
 ...
 * @psalm-type ESSuggests = array<string, array<array-key, array{text: string, offset: int, length: int, options: array<array-key, ESSuggestOption>}>>
