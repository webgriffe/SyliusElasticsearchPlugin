 ...
 * @psalm-type ESDefaultOptionAggregation = array{meta: array{type: string}, doc_count: int, filter_by_key: array{doc_count: int, values: array{doc_count: int, values: ESValuesAggregation, name: array{doc_count: int, filter_value_name_by_locale: array{doc_count: int, values: ESValuesAggregation}}}, name: array{doc_count: int, filter_name_by_locale: array{doc_count: int, values: ESValuesAggregation}}}}
