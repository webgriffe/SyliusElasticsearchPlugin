...
return static function (ContainerConfigurator $container): void {
    $container->extension('sylius_twig_hooks', [
        'hooks' => [
            ...
            'webgriffe_sylius_elasticsearch.product.index.content.body.main.filters' => [
                'controls' => [
            ...
            'webgriffe_sylius_elasticsearch.product.index.content.body.main.filters.controls' => [
                'limit' => [
                    'template' => '@SyliusShop/product/index/content/body/main/filters/controls/limit.html.twig',
                    'priority' => 100,
                ],
                'sort' => [
                    'template' => '@WebgriffeSyliusElasticsearchPlugin/shop/product/index/content/body/main/filters/controls/sorting.html.twig',
                    'priority' => 0,
                ],
            ],

            'webgriffe_sylius_elasticsearch.product.index.content.body.main.filters.controls.limit' => [
                'toggle' => [
                    'template' => '@WebgriffeSyliusElasticsearchPlugin/shop/product/index/content/body/main/filters/controls/limit/toggle.html.twig',
                    'priority' => 100,
                ],
                'menu' => [
                    'template' => '@WebgriffeSyliusElasticsearchPlugin/shop/product/index/content/body/main/filters/controls/limit/menu.html.twig',
                    'priority' => 0,
                ],
            ],

            'webgriffe_sylius_elasticsearch.product.index.content.body.main.filters.controls.sorting' => [
                'toggle' => [
            ...
            'webgriffe_sylius_elasticsearch.product.index.content.body.main.filters.controls.sorting.menu' => [
                'default' => [
